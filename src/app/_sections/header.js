        ...
        <section className="flex items-center justify-center lg:block bg-peach py-[2rem] px-[1.5rem] lg:py-[5rem] lg:pt-[3rem] lg:px-[3.5rem] md:px-8">
          <div className="grid grid-cols-1 items-start lg:grid lg:grid-cols-2 gap-4 items-center md:justify-between">
            ...
            <div className="col-span-1 lg:mb-20 text-center lg:text-left">
              ...
              <h1 className="text-[1.5rem] xl:text-5xl md:text-2xl font-bold text-slate-800 leading-tight whitespace-nowrap font-tanker">
                HEALTH WITH GOOD GUT
              </h1>
              <h1 className="text-[1.5rem] xl:text-5xl md:text-2xl font-bold text-slate-800 leading-tight font-tanker">
                PROJECT
              </h1>
              <p className="text-lg xl:text-2xl md:text-xl text-slate-600 mt-[3rem] md:mt-6">
                Tailored Diet Plans, Professional Advice, and Trusted Health
                Content for Your Wellness Journey
              </p>
              <div className="lg:flex items-center mt-4 md:mt-6">
                ...
                <p className="text-orange-500 text-lg ml-4">
                  5.0{" "}
                  <span className="text-slate-500">
                    From 50+ Success Stories
                  </span>
                </p>
              </div>
