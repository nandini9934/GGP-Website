      ...
      < section className="container mx-auto">
        <div className="relative flex flex-col items-center justify-center h-[550px] bg-peach">
          ...
          <div className="absolute bottom-0 w-full bg-[#f27c21] h-[120px] rounded-t-full flex flex-col justify-center items-center">
            ...
            <li>
                <Link href="/privacy-policy" className="text-sm text-white font-bold  opacity-90 hover:opacity-100 underline transition-opacity">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/cancellation-refund" className="text-sm text-white font-bold opacity-90 hover:opacity-100 underline ">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/shipping-exchange" className="text-sm text-white font-bold opacity-90 hover:opacity-100 underline ">
                  Exchange Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm text-white font-bold opacity-90 hover:opacity-100 underline ">
                  Terms & Conditions
                </Link>
              </li>
            </ul>
            <p className="text-sm text-white font-bold mt-2 text-center">©2024 Good Gut Project. All Rights Reserved.</p>
          </div>
